...
let
  ...
  f = { mkDerivation, acid-state, aeson, attoparsec, base
      ...
      , bytestring-conversion, clientsession, containers, cookie, either
      , exceptions, file-embed, filepath, highlighter, http-media
      ...
      mkDerivation {
        ...
        libraryHaskellDepends = [
          ...
          blaze-markup bytestring bytestring-conversion clientsession
